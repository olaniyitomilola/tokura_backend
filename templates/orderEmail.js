    ...
    <tr>
      <td align="center">
        <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden;">
          ...
          <!-- Greeting with Burgundy Background -->
          <tr>
            <td >
              <h2 style="padding:20px; background:linear-gradient(135deg,#b1687a,#91515e,#755157,#e49aa5); color:#ffffff;" style="margin-top:0; color:#ffffff;">Thank you for your order, ${customerName}!</h2>
              ...
              <p style="font-size:16px; line-height:1.5; margin:0;">
                ...
                <a href="https://www.tokuraluxury.com/order" target="_blank" style="color:#FFD700; text-decoration:none;">
                  www.tokuraluxury.com/order
                </a>.
              </p>
          ...
          <tr>
            <td style="padding:20px;">
              <h3 style="border-bottom:1px solid #ddd; padding-bottom:8px; margin:0 0 10px 0;">Order Summary</h3>
          ...
          <tr>
            <td style="padding:20px;">
              <h3 style="border-bottom:1px solid #ddd; padding-bottom:8px; margin:0 0 10px 0;">Delivery Information</h3>
